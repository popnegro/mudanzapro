      ...
      <div className="max-w-5xl mx-auto">
        <div className="text-center space-y-3">
          <span className="text-xs font-bold text-amber-700 bg-amber-50 px-3 py-1 rounded-full uppercase tracking-wider">
            MUDANZAPRO · QUÉ HACER
          </span>
          <h2 className="text-3xl sm:text-4xl font-extrabold text-gray-900 tracking-tight">
            Pasá de la información a la acción
          </h2>
          <p className="text-sm text-gray-500 max-w-2xl mx-auto leading-relaxed">
            MudanzaPro es la capa de planificación y conversión. Te ayuda a
            estimar, ordenar y preparar tu mudanza antes de solicitar una
            cotización a un proveedor.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-5 mt-10">
          <button
            ...
            className="group text-left rounded-3xl border border-gray-200 bg-slate-50 p-7 hover:border-amber-400 hover:shadow-md transition"
          >
            ...
            <p className="mt-2 text-sm text-gray-500 leading-relaxed">
              Organizá los datos principales del traslado y prepará una base
          ...
          >
            ...
            <p className="mt-2 text-sm text-gray-500 leading-relaxed">
              Usá el checklist para ordenar tareas, embalaje y decisiones antes
              del día del traslado.
            </p>
          </button>
        </div>
        ...
        <div className="mt-8 flex items-start gap-3 rounded-2xl border border-gray-100 bg-white p-5 text-sm text-gray-500">
          ...
          <p>
            MudanzaPro no se presenta como una empresa de mudanzas ni como un
            directorio de prestadores. La contratación se deriva a la marca o
            proveedor correspondiente una vez definido el servicio.
          </p>
        </div>
      </div>
    </section>
