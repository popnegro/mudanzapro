      ...
      <div className="max-w-3xl mx-auto space-y-10">
        <div className="text-center space-y-3">
          ...
          <p className="text-sm text-gray-500 max-w-xl mx-auto">
            ¿Tienes dudas sobre los costos, seguros o permisos municipales en
            Mendoza? Encuentra las respuestas comunes a continuación.
          </p>
        </div>
              ...
              >
                ...
                >
                  <div className="flex items-center gap-3">
                    <HelpCircle
                      className={`w-5 h-5 shrink-0 transition-colors duration-300 ${isOpen ? "text-amber-500" : "text-gray-400"}`}
                      aria-hidden="true"
                    />
                    <span
                      itemProp="name"
                      className={`text-xs sm:text-sm font-bold transition-colors duration-300 ${isOpen ? "text-gray-900" : "text-gray-700"}`}
                    >
                      {item.q}
                    </span>
                  </div>
                  <div
                    className={`w-6 h-6 rounded-full flex items-center justify-center transition-colors duration-300 ${isOpen ? "bg-amber-100 text-amber-600" : "bg-slate-100 text-gray-400"}`}
                  >
                    {isOpen ? (
                      <ChevronUp
                  ...
                  {isOpen && (
                    ...
                    >
                      <div className="px-5 pb-5 pt-0 text-xs text-gray-600 leading-relaxed border-t border-slate-50">
                        <div
                          itemProp="text"
                          className="bg-slate-50/70 p-4 rounded-xl text-xs text-gray-600 border border-slate-100 leading-relaxed"
                        >
                          {item.a}
                        </div>
                      </div>
