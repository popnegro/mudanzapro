                    ...
                    return (
                      ...
                      >
                        <button
                          ...
                          aria-label={isChecked ? "Marcar como no completada" : "Marcar como completada"}
                        >
                          {isChecked ? (
                        ...
                        <p className={`text-xs text-gray-700 leading-normal ${isChecked ? 'line-through text-gray-400' : 'font-semibold text-gray-700'}`}>
                          {step.text}
                        </p>
                      </motion.div>
                    );
          ...
          {completionPercent === 100 && (
            ...
            >
              <span className="text-xs font-bold text-emerald-800 flex items-center justify-center gap-1.5">
                <Sparkles className="w-4 h-4 text-emerald-600 animate-spin" style={{ animationDuration: '3s' }} /> ¡Estás 100% Organizado! Felicitaciones.
              </span>
