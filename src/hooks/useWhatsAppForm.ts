...
export function useWhatsAppForm() {
  ...
  const getWaMsgHint = () => {
    ...
    const hasBienes = lowerMsg.includes('mueble') || lowerMsg.includes('sillon') || lowerMsg.includes('heladera') || lowerMsg.includes('caja') || lowerMsg.includes('camas') || lowerMsg.includes('lavarropas') || lowerMsg.includes('cosa') || lowerMsg.includes('piano') || lowerMsg.includes('mesa') || lowerMsg.includes('traslado') || lowerMsg.includes('mudanza');
    if (!hasBienes) {
