import { Department, ServiceItem, FurnitureItem, BrandConfig, QuoteLead, RecommendedCompany } from './types';
...
export const DEPARTMENTS: Department[] = [
  {
    ...
    featuredNeighborhoods: ['Quinta Sección', 'Bombal', 'Sexta Sección', 'Microcentro', 'Barrio Cívico'],
    description: 'La zona céntrica de Mendoza. Accesos rápidos pero mayor complejidad de estacionamiento y tránsito. Requiere permisos municipales específicos para mudanzas diurnas.',
    movingStats: {
      monthlyVolume: 124,
      avgCost: 110000,
  ...
  },
  {
    ...
    featuredNeighborhoods: ['Chacras de Coria', 'Vistalba', 'La Puntilla', 'Carrodilla', 'Mayor Drummond'],
    description: 'Zona residencial premium de Mendoza. Distancias más largas, calles arboladas angostas y accesos a barrios privados residenciales con rigurosas normas de ingreso de camiones.',
    movingStats: {
      monthlyVolume: 98,
      avgCost: 145000,
  ...
  },
  {
    ...
    featuredNeighborhoods: ['Dorrego', 'Villa Nueva', 'San José', 'Las Cañas', 'Rodeo de la Cruz'],
    description: 'El departamento más poblado de la provincia. Gran volumen comercial y residencial. Las zonas de Dorrego y Las Cañas registran la mayor densidad de mudanzas de departamentos.',
    movingStats: {
      monthlyVolume: 162,
      avgCost: 95000,
  ...
  },
  {
    ...
    featuredNeighborhoods: ['Luzuriaga', 'Coquimbito', 'Gutiérrez', 'Maipú Centro', 'Russell'],
    description: 'Mezcla de zonas residenciales en auge y áreas agrícolas. Luzuriaga destaca por la afluencia de jóvenes familias mudándose a nuevos dúplex y complejos habitacionales.',
    movingStats: {
      monthlyVolume: 85,
      avgCost: 130000,
  ...
  },
  {
    ...
    featuredNeighborhoods: ['El Challao', 'Panquehua', 'El Plumerillo', 'Uspallata', 'Las Heras Centro'],
    description: 'Amplia geografía que incluye desde el pedemonte de El Challao hasta zonas urbanas e industriales. El Challao requiere vehículos con potencia adecuada para pendientes.',
    movingStats: {
      monthlyVolume: 74,
      avgCost: 125000,
      popularTime: 'Sábados',
  ...
  },
  {
    ...
    featuredNeighborhoods: ['San Rafael Centro', 'Rama Caída', 'Las Paredes', 'Cuadro Nacional', 'El Cerrito'],
    description: 'La capital turística y de servicios del Sur mendocino. Gran volumen de mudanzas de larga distancia residencial y traslados comerciales desde o hacia la ciudad de Mendoza.',
    movingStats: {
      monthlyVolume: 34,
      avgCost: 350000,
  ...
  },
  {
    ...
    featuredNeighborhoods: ['Malargüe Centro', 'Las Leñas', 'El Sosneado', 'Coihueco'],
    description: 'El departamento más austral y extenso de Mendoza. Rutas cordilleranas y condiciones climáticas extremas en invierno. Servicios especiales para el complejo Las Leñas y yacimientos.',
    movingStats: {
      monthlyVolume: 12,
      avgCost: 450000,
  ...
  },
  {
    ...
    slug: 'san-carlos',
    baseRateMultiplier: 1.3,
    featuredNeighborhoods: ['La Consulta', 'Eugenio Bustos', 'Pareditas', 'San Carlos Centro'],
    description: 'Departamento histórico del Valle de Uco. Servicios frecuentes de mudanzas agrícolas y residenciales conectando con la Ciudad de Mendoza a través de la mítica Ruta Nacional 40.',
    movingStats: {
      monthlyVolume: 16,
      avgCost: 250000,
      popularTime: 'Sábados por la mañana',
...
export const SERVICES: ServiceItem[] = [
  ...
  },
  {
    ...
    icon: 'Sparkles',
    description: 'Mudanza llave en mano. Incluye personal de carga/descarga, estiba profesional y cuidado de muebles.',
    basePrice: 95000,
  ...
  },
  {
    ...
    icon: 'Archive',
    description: 'Protección extrema de tus bienes con materiales importados de alta resistencia antes del traslado.',
    basePrice: 30000,
  ...
  },
  {
    ...
    icon: 'Users',
    description: 'Operarios adicionales capacitados para traslados complejos o escaleras complicadas.',
    basePrice: 25000,
  ...
  },
  {
    ...
    icon: 'Warehouse',
    description: 'Almacenamiento temporal seguro y monitoreado para tus pertenencias en bauleras individuales.',
    basePrice: 40000,
  ...
  },
  {
    ...
    icon: 'ArrowUpCircle',
    description: 'Sistemas de sogas, poleas, arneses de escalada e izamiento exterior de muebles de grandes dimensiones para departamentos céntricos.',
    basePrice: 65000,
...
export const FURNITURE_ITEMS: FurnitureItem[] = [
  // Living
  { id: 'sofa_3c', name: 'Sofá Grande (3 cuerpos)', category: 'living', volumePoints: 12 },
  { id: 'sofa_2c', name: 'Sofá Mediano (2 cuerpos)', category: 'living', volumePoints: 8 },
  { id: 'mesa_com', name: 'Mesa de Comedor Grande', category: 'living', volumePoints: 10 },
  { id: 'sillas', name: 'Juego de Sillas (x6)', category: 'living', volumePoints: 9 },
  { id: 'tv_rack', name: 'Mesa / Rack de TV grande', category: 'living', volumePoints: 7 },
  { id: 'televisor', name: 'Televisor Smart TV (>55")', category: 'living', volumePoints: 3 },
  
  // Dormitorio
  { id: 'cama_mat', name: 'Cama Matrimonial / Queen / King', category: 'dormitorio', volumePoints: 14 },
  { id: 'cama_1p', name: 'Cama de 1 Plaza (con colchón)', category: 'dormitorio', volumePoints: 7 },
  { id: 'placard', name: 'Placard / Ropero (Desarmado)', category: 'dormitorio', volumePoints: 15 },
  { id: 'comoda', name: 'Cómoda / Cajonera de madera', category: 'dormitorio', volumePoints: 8 },
  { id: 'mesa_luz', name: 'Mesa de Luz (Par)', category: 'dormitorio', volumePoints: 4 },
  
  // Cocina
  { id: 'heladera', name: 'Heladera / Freezer Grande', category: 'cocina', volumePoints: 13 },
  { id: 'lavarropas', name: 'Lavarropas automático', category: 'cocina', volumePoints: 6 },
  { id: 'cocina_gas', name: 'Cocina / Horno a Gas', category: 'cocina', volumePoints: 5 },
  { id: 'microondas', name: 'Microondas / Horno Eléctrico', category: 'cocina', volumePoints: 2 },
  
  // Otros
  { id: 'caja_g', name: 'Caja de Cartón Grande (Vajilla/Ropa)', category: 'otros', volumePoints: 2 },
  { id: 'caja_m', name: 'Caja de Cartón Mediana', category: 'otros', volumePoints: 1 },
  { id: 'escritorio', name: 'Escritorio de Oficina / PC', category: 'otros', volumePoints: 8 },
  { id: 'bici', name: 'Bicicleta', category: 'otros', volumePoints: 3 },
  { id: 'espejo', name: 'Espejo Grande / Cuadro frágil', category: 'otros', volumePoints: 3 }
];
...
export const INITIAL_LEADS: QuoteLead[] = [
  {
    ...
    status: 'new',
    notes: 'Cliente solicita sumo cuidado con piano vertical de herencia (no cargado en cotizador, se cobrará un extra en visita técnica).'
  },
  {
    id: 'lead-2',
  ...
  },
  {
    ...
    servicesSelected: ['mudanza_premium', 'embalaje_proteccion', 'operarios_extra'],
    distanceKm: 15,
    hasElevatorOrigin: true,
    ...
    status: 'new',
    notes: 'Mudanza de estudio de arquitectura completo. Gran cantidad de planos enrollados y computadoras delicadas. Requiere factura A.'
  },
  {
    id: 'lead-4',
...
export const CHECKLIST_STEPS = [
  ...
  { id: 'check-5', category: '1 Semana Antes', text: 'Empezar a embalar lo no esencial de las habitaciones secundarias. Rotular cada caja con el cuarto de destino.' },
  { id: 'check-6', category: '1 Semana Antes', text: 'Dar de baja o transferir servicios de internet, luz, gas y agua en el domicilio viejo.' },
  { id: 'check-7', category: '3 Días Antes', text: 'Descongelar y secar la heladera y el freezer para evitar goteos y malos olores en el camión.' },
  { id: 'check-8', category: '3 Días Antes', text: 'Asegurar el estacionamiento para el camión de mudanza frente a ambas viviendas.' },
  { id: 'check-9', category: 'Día de la Mudanza', text: 'Armar una "caja de supervivencia" para el primer día con cargadores, elementos de higiene, toallas y mudas de ropa.' },
  { id: 'check-10', category: 'Día de la Mudanza', text: 'Hacer una recorrida final por todos los placares y alacenas de la casa vieja para asegurarte de no olvidar nada.' }
];
...
export const RECOMMENDED_COMPANIES: RecommendedCompany[] = [
  {
    ...
    reviewsCount: 342,
    phone: '+54 261 455-8899',
    whatsappMessage: 'Hola Mudanzas Mendoza, vi su recomendación en el portal y quiero cotizar una mudanza residendial local.',
    location: 'Av. San Martín 1240, Godoy Cruz, Mendoza',
    specialties: ['Mudanza Hogar', 'Izajes', 'Mudanza Oficina', 'Embalaje Vajilla'],
    zones: ['Gran Mendoza', 'Valle de Uco'],
    features: ['Habilitación Municipal', 'Personal de Carga Seguro', 'Sogas y Poleas Pro'],
    isFeatured: true,
    minPrice: 85000,
  ...
  },
  {
    ...
    reviewsCount: 189,
    phone: '+54 11 5233-9800',
    whatsappMessage: 'Hola Mudanzas Miranda Mendoza, vengo desde el portal y deseo un presupuesto para traslado interurbano / piano.',
    location: 'Lateral Este Acceso Sur, Luján de Cuyo, Mendoza',
    specialties: ['Traslado Pianos', 'Larga Distancia', 'Mudanza Premium', 'Guarda Muebles'],
    zones: ['Gran Mendoza', 'Zona Sur', 'Valle de Uco'],
    features: ['Flota con GPS Satelital', 'Habilitado CNRT RUTA', 'Seguro Todo Riesgo'],
    isFeatured: true,
    minPrice: 120000,
